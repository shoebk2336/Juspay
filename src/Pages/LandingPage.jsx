  ...
  return (
    <div className="flex flex-col gap-6 overflow-x-hidden mx-auto px-4 max-w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        <ChartLineMultiple className="w-full sm:flex-1" />

        {/* Revenue Card */}
        <Card className="w-full sm:max-w-1/4">
          <CardHeader>
            <CardTitle className="text-left text-sm">
              Revenue by Location
            </CardTitle>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <img
                className="w-[70%] max-w-full h-40 sm:h-[25%] m-auto hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer"
                src="worldMap.png"
                alt="worldmap"
              />
            </TooltipTrigger>
